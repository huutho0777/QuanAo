<?php
	...
	$sql_cate = mysqli_query($con,"SELECT * FROM tbl_sanpham where category_id = $id ORDER BY sanpham_id DESC");	
	$sql_category = mysqli_query($con, "SELECT * FROM `tbl_category` WHERE category_id = $id");
	$row_title = mysqli_fetch_assoc($sql_category); // mảng kết hợp
								...
								<div class="col-md-4 product-men mt-5">
									<div class="men-pro-item simpleCart_shelfItem">
										<div class="men-thumb-item text-center">
											<img style="width:300px;height:400px;object-fit:cover" src="images/<?php echo $row_sanpham['sp_image'] ?>" alt="">
