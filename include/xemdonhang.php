					...
					<div class="wrapper">
						<!-- first section -->
							...
							<div class="col-md-12">
								...
								$sql_select = mysqli_query($con,"SELECT * FROM tbl_giaodich WHERE khachhang_id='$id_khachhang' ORDER BY ngaythang DESC");
							...
							<div class="col-md-12">
								...
								$sql_select = mysqli_query($con,"SELECT * FROM tbl_giaodich,tbl_khachhang,tbl_sanpham WHERE tbl_giaodich.sanpham_id=tbl_sanpham.sanpham_id AND tbl_khachhang.khachhang_id=tbl_giaodich.khachhang_id AND tbl_giaodich.magiaodich='$magiaodich' ORDER BY tbl_giaodich.giaodich_id DESC"); //chi tiết đơn hàng
								?> 
								<table class="table table-bordered ">
									<tr>
										<th>Thứ tự</th>
